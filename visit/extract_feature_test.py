...
csv_name = ['buliding_id', 'peron_sum','visit_sum','ave_visit_P','visit_morethan2_ratio','visit_morethan10_ratio',
...
for path in ret:
    ...
    if train_timenum >= txt_start:
        with open(path, "a", encoding="utf-8")as f:
            ...
            id = str(path[path.rfind("\\") + 1:path.rfind(".")])
            list += [[id,peron_sum,visit_sum,ave_visit_P,visit_morethan2_ratio,visit_morethan10_ratio,visit_morethan30_ratio,
